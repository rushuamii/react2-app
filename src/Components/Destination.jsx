  ...
  return (
    <div className="destination">
      ...
      <DestinationData
        ...
        The Jaysons Holdings portfolio includes the famous Glendower, an English country manor type hotel opened in 1991, and the pioneering beach restaurant Golden Mile at Mount Lavinia now known as the Shore by O."
        img1={
